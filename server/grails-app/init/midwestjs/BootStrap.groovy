...
//        Speaker speaker2 = new Speaker(fullName: 'Cory Tranby', email: 'cory@agileorbit.com').save(failOnError: true)
//        Talk talk1 = new Talk(speaker: speaker1, title: 'Do more with jQuery', approved: true, conferenceYear: 2017).save(failOnError: true)
//        Talk talk2 = new Talk(speaker: speaker2, title: 'Advanced jQuery', talkAbstract: "\$('#mydiv').parent().parent().parent().html()", approved: false, conferenceYear: 2017).save(failOnError: true)
//
